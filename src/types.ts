...
export const INITIAL_CHECKLIST: Omit<ChecklistItem, 'id'>[] = [
  ...
  { section: '💰 3. Budget & finance', text: '0', completed: false, status: 'Pas commencé', indent: 1, type: 'currency', label: 'Badge invités' },
  { section: '💰 3. Budget & finance', text: 'Cofinancement des partenaires', completed: false, status: 'Pas commencé' },
  { section: '💰 3. Budget & finance', text: '0', completed: false, status: 'Pas commencé', indent: 1, type: 'number', label: 'Part Thalès (%)' },
  ...
  { section: '💰 3. Budget & finance', text: '0', completed: false, status: 'Pas commencé', indent: 1, type: 'number', label: 'Part Factorial (%)' },
  ...
  { section: '💰 3. Budget & finance', text: '0', completed: false, status: 'Pas commencé', indent: 1, type: 'number', label: 'Part Sage (%)' },
  ...
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: '⏰ 14:00 – 14:30 | Accueil & coffee break ☕', completed: false, status: 'Pas commencé', type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Accueil des participants & check-in', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Café / rafraîchissements & networking informel', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Diffusion de contenu (slides / vidéo branding)', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: '⏰ 14:30 – 14:40 | Mot d’ouverture 🎤', completed: false, status: 'Pas commencé', type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Mot de bienvenue', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Présentation des objectifs', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Introduction de l’événement & de Factorial', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: '⏰ 14:40 – 15:20 | Présentation de la thématique – Digitalisation des RH 📊', completed: false, status: 'Pas commencé', type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Enjeux & Tendances de la transformation digitale RH', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Impact sur la performance & Rôle des SIRH', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: '👉 Objectif : poser le cadre, créer le besoin et engager l’audience', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: '⏰ 15:20 – 15:35 | Pause networking ☕', completed: false, status: 'Pas commencé', type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Échanges entre participants', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Discussions avec les équipes', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: '⏰ 15:35 – 16:05 | Démo Factorial 💻', completed: false, status: 'Pas commencé', type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Démo de la plateforme', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Cas d’usage concrets', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Mise en situation réelle', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: '⏰ 16:05 – 16:25 | Quiz & Session Q&A interactive 💬', completed: false, status: 'Pas commencé', type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Quiz de connaissances / Sondage live', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Questions / réponses & Interaction', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: '⏰ 16:25 – 16:40 | Tombola & animation 🎁', completed: false, status: 'Pas commencé', type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Tirage au sort', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Annonce des gagnants', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: '⏰ 16:40 – 16:50 | Closing & Call-to-action 🚀', completed: false, status: 'Pas commencé', type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Remerciements', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Synthèse des points clés', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Invitation à prendre RDV / démo', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: '⏰ 16:50 – 17:20 | Networking & cocktail de clôture 🍹', completed: false, status: 'Pas commencé', type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Échanges informels', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Discussions commerciales', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '🗓️ 5. Agenda détaillé – Événement Factorial (14h00 – 17h20)', text: 'Opportunités business', completed: false, status: 'Pas commencé', indent: 1, type: 'text' },
  { section: '📢 6. Communication & marketing', text: '1. Invitations & Diffusion (Email / LinkedIn)', completed: false, status: 'Pas commencé' },
  { section: '📢 6. Communication & marketing', text: 'Séquence emailing (J-18) & Ciblage (DRH, DAF, DIR)', completed: false, status: 'Pas commencé', indent: 1 },
  { section: '📢 6. Communication & marketing', text: 'Planning LinkedIn (Annonce J-18, Rappel J-7, Last Call J-2)', completed: false, status: 'Pas commencé', indent: 1 },
...
export const OWNERS = ['Badr', 'Ayoub', 'Sanaa', 'Yassine'];
